...
src_install() {
    ...
    insinto /etc/wleave
    doins style.css layout.json

    newbashcomp completions/wleave.bash wleave
    dozshcomp completions/_wleave
    dofishcomp completions/wleave.fish

    insinto "/usr/share/$PN"
    doins -r icons

    doman wleave.{1,5} wleave.json.5
}
